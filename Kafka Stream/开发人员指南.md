...
- [编写一个流应用程序](https://kafka.apache.org/10/documentation/streams/developer-guide/)
- [配置一个流应用](https://kafka.apache.org/10/documentation/streams/developer-guide/config-streams.html)
- [Streams DSL](https://kafka.apache.org/10/documentation/streams/developer-guide/dsl-api.html)
